...
def _rules():
    ...
    rules['carboxyl_methyl'] = (
        smarts('[C:1](=[O;D1])-[O;D2]-[C;D1]'),
        [1],
        [(1, 'O', 1)],
        'CC(=O)OC',
        'CC(=O)O',
    ...
    rules['carboxyl_ethyl'] = (
        smarts('[C:1](=[O;D1])-[O;D2]-[C;D2]-[C;D1]'),
        [1],
        [(1, 'O', 1)],
        'CC(=O)OCC',
        'CC(=O)O',
    ...
    rules['carboxyl_butyl'] = (
        smarts('[C:1](=[O;D1])-[O;D2]-[C;D2]-[C;D2]-[C;D2]-[C;D1]'),
        [1],
        [(1, 'O', 1)],
        'CC(=O)OCCCC',
        'CC(=O)O',
    ...
    rules['amine_phenylsulfonyl'] = (
        smarts('[N,n;D2,D3:1]-;!@[S;D4;x3](=O)(=O)-[C;a;r6]:1:[C;D2]:[C;D2]:[C;D2]:[C;D2]:[C;D2]:1'),
        [1],
        [],
    ...
    rules['amine_tosyl'] = (
        smarts('[N,n;D2,D3:1]-;!@[S;D4;x3](=O)(=O)-[C;a;r6]:1:[C;D2]:[C;D2]:[C;D3;x0]([C;D1]):[C;D2]:[C;D2]:1'),
        [1],
        [],
    ...
    rules['amine_nosyl'] = (
        smarts('[N,n;D2,D3:1]-;!@[S;D4;x3](=O)(=O)-[C;a;r6]:1:[C;D3;x1]([N+](=O)[O-]):[C;D2]:[C;D2]:[C;D2]:[C;D2]:1'),
        [1],
        [],
